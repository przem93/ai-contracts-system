...
/**
 * Service for generating text embeddings using the Xenova/bge-small-en-v1.5 model
 * from HuggingFace via @xenova/transformers
 * 
 * This model is specifically designed for semantic search and retrieval tasks.
 * Note: Using Xenova/bge-small-en-v1.5 instead of google/embeddinggemma-300m
 * because the Google model requires authentication or is not available in ONNX format.
 */
@Injectable()
